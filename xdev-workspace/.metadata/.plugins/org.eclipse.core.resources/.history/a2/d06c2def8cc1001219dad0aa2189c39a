 ...
 *******************************************************************************/
package at.bestsolution.efxclipse.runtime.workbench.fx;
...
public class PartRenderingEngine implements IPresentationEngine {
	public static final String engineURI = "bundleclass://at.bestsolution.efxclipse.runtime.workbench.fx/"
			+ "at.bestsolution.efxclipse.runtime.workbench.fx.PartRenderingEngine";
